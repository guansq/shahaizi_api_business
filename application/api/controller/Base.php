...
class Base extends Controller {
    ...
    public function checkToken()
    {
        ...
        $check_arr = [
            'pack'      => ['index','auth_img','auth_img_up','actionCar',"getMyCar","delMyCar","getMyCarInfo","overtime","publishLine","confirmOrder","getLinelist","lineDetail","delLine","getOvertime","postComment","getOrderComment","getOrderAllComment","coverImg","back_edit"],
            ...
            'order'     => ['add_comment', 'ajaxZan', 'cancel_order', 'checkType', 'comment', 'complain_handle', 'conmment_add', 'delComment', 
                ...
                'return_goods_cancel', 'return_goods_index', 'return_goods_info', 'return_goods_list', 'return_goods_refund','workstation','singleWork','air_status','myOrder',"missOrder","orderNum"],
	        'payment'   => ['alipay_sign'],
            ...
            'user'      => ['account', 'account_list', 'addAddress', 'add_comment', 'add_service_comment', 'cancelOrder', 'clear_message',
                ...
                'visit_log','withdrawals','withdrawals_list','getMine','updateInfo','getMyInfo',"suggestionFeedback","getWithdrawals","postWithdrawals","getWithdrawalList","checkSms","updateMobile","getHxSingleUser","getSellerHx"],
        ];
